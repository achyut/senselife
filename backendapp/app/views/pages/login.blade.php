        ...
        <div class="login login-with-news-feed">
            ...
            <div class="right-content">
                ...
                <div class="login-content">
                    ...
                    <form action="{{{ URL::to('login') }}}" method="POST" class="margin-bottom-0" data-parsley-validate="true">
                        <div class="form-group m-b-20">
                            <input type="email" data-parsley-required="true" class="form-control input-lg" placeholder="Email Address" name="email" value="{{{ Input::old('email') }}}" />
                        </div>
                        <div class="form-group m-b-20">
                            <input type="password" data-parsley-required="true" class="form-control input-lg" placeholder="Password" name="password" />
                        </div>
                        ...
                        <div class="m-t-20">
                            Need help? Click <a href="/users/forgot_password">here</a> to get new password.
                        </div>
                        <hr />
